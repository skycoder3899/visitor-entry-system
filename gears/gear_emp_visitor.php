...
$e_id= $_SESSION['e_id'];
 $output = '';  
 $sql = "SELECT * FROM `visitor_tbl` v INNER JOIN employee_dept_tbl d ON v.host_department_id=d.department_id INNER JOIN employee_tbl e on v.host_id=e.e_id WHERE e.e_id=$e_id";  
